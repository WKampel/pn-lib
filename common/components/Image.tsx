...
export const Image = ({ source, style, contentFit = 'contain' }: { source: ImageSource | string; style?: object; contentFit?: ImageContentFit }) => {
  ...
  return <ExpoImage key={source.toString()} contentFit={contentFit} transition={500} placeholder={blurhash} source={source} style={style} />
}
